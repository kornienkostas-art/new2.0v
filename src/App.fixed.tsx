...
export default function App() {
  ...
  if (screen === "mkl") return <MklScreen onBack={() => setScreen("menu")} />;
...
function MklScreen({ onBack }: { onBack: () => void }) {
  ...
  const [selectedStatus, setSelectedStatus] = useState<string>("Заказан");
          ...
          <DialogBody>
            ...
            <DialogContent>
              <Dropdown
                ...
                onOptionSelect={(_, data) => setSelectedStatus((data.optionValue as string) || "Заказан")}
              >
